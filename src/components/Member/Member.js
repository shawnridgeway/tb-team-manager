    ...
    return (
      ...
      >
        <div className="member-pictureCtr">
          {this.props.hoverImage && this.state.hovered && this.props.hoverImage}
          {!(this.props.hoverImage && this.state.hovered) && (
            <img className={pictureClass} src={picture} alt={member.username} />
          )}
        </div>
        <div className="member-nameCtr">
          {this.props.tightView && <div>{member.username}</div>}
