...
class MemberSelector extends React.Component {
  ...
  render() {
    const memberOptions = this.props.allMembers.filter(
      member =>
        this.props.selectedMembers.indexOf(member.id) === -1 &&
        member.username
          .toLowerCase()
      ...
      <div>
        ...
        {memberOptions.length === 0 && (
          <div className="memberSelector-noResults">
            <div className="memberSelector-title text-highlighted">
              Team member not found.
            </div>
            <small className="memberSelector-subtext">
              Maybe he/she is not in your <a href="#">team</a>.
            </small>
          </div>
        )}
      </div>
